          ...
          <svg width="550" height="650" viewBox="0 0 400 500" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fill="url(#block-print)" opacity="0.9" stroke="#E65828" strokeWidth="0.5">
              <animate
                ...
                values="M 175 125 C 150 180, 120 300, 110 430 C 130 440, 150 350, 170 250 C 180 190, 185 140, 190 135 Z;M 175 125 C 130 190, 90 310, 80 440 C 110 450, 140 360, 160 260 C 170 200, 185 140, 190 135 Z;M 175 125 C 150 180, 120 300, 110 430 C 130 440, 150 350, 170 250 C 180 190, 185 140, 190 135 Z"
              />
            </path>
            ...
            <path fill="url(#block-print)" opacity="0.95" stroke="#E65828" strokeWidth="0.5">
              <animate
                ...
                dur="6s"
                repeatCount="indefinite"
                values="M 215 125 C 230 160, 240 190, 260 210 C 300 280, 340 380, 330 470 C 280 480, 240 460, 220 450 C 220 350, 220 200, 215 125 Z;M 215 125 C 230 160, 240 190, 260 210 C 330 290, 390 390, 370 480 C 300 490, 250 470, 220 450 C 220 350, 220 200, 215 125 Z;M 215 125 C 230 160, 240 190, 260 210 C 300 280, 340 380, 330 470 C 280 480, 240 460, 220 450 C 220 350, 220 200, 215 125 Z"
              />
            </path>
